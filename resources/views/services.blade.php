...
@section('title', 'Các dịch vụ - ' . app_name())
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
              <div class="icon-box iconbox-blue flex-fill">
                  ...
                  <p>Được sử dụng trong các hệ thống kinh doanh, tài chính và hành chính cho các công ty, COBOL được sử dụng rộng rãi trong các ứng dụng cũ</p>
              </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4 mt-lg-0" data-aos="zoom-in"
              ...
              <div class="icon-box iconbox-pink">
                  ...
                  <h4><a href="{{ route('outsourcing-frontend-development') }}">Phát triển Outsource Front-end</a></h4>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch mt-4" data-aos="zoom-in" data-aos-delay="200">
              <div class="icon-box iconbox-red">
                  ...
                  <h4><a href="{{ route('smartphone-application-development') }}">Phát triển Mobile và Ứng dụng</a></h4>
