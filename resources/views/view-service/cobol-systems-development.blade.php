...
<style>
    ...
    <section class="header" style="background-image: url({{ asset('servicecss/img/cobol/demo.png')}})">
        <div class="container">
            <div class="row">
                <div class="col-md-5 col-sm-12">
                    <div class="box__title mb-5 mt-5 pb-5 pt-5">
                        <h1 class="title text-body mb-5">COBOL DEVELOPMENT</h1>
                        <p class="text-body">Being used in business, finance, and administrative systems for companies, COBOL
                ...
                <div class="col-md-7 col-sm-12">
                    <div class="box__img mb-5 mt-5 pb-5 pt-5">
                        <img src="{{ asset('servicecss/img/cobol/cobol-image-header.png')}}"
                            alt="cobol systems development">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section id="service_provided" class="pb-5 pt-3"
        style="background-image: url({{ asset('servicecss/img/cobol/bg-service-provide.png')}})">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6 col-6 mb-3">
                    <div class="box__image w-100">
                        <img src="{{ asset('servicecss/img/cobol/image-app-development.png')}}" alt=""
                            class=" w-100">
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-6 mb-3">
                ...
                <div class="col-md-3 col-sm-6 col-6 mb-3">
                    <div class="box__image w-100">
                        <img src="{{ asset('servicecss/img/cobol/image-app-maintenance.png')}}" alt=""
                            class=" w-100">
                    </div>
                </div>
                ...
                <div class="col-md-3 col-sm-6 col-6 mb-3">
                    <div class="box__image w-100">
                        <img src="{{ asset('servicecss/img/cobol/image-deployment.png')}}" alt=""
                            class=" w-100">
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-6 mb-3">
                ...
                <div class="col-md-3 col-sm-6 col-6 mb-3">
                    <div class="box__image w-100">
                        <img src="{{ asset('servicecss/img/cobol/image-report.png')}}" alt="" class=" w-100">
                    </div>
                </div>
                <div class="col-md-3 col-sm-6 col-6 mb-3">
                    <div class="box__icon">
    ...
    <section id="product_solutions" class="pt-3 pb-5"
        style="background-image: url({{ asset('servicecss/img/cobol/bg-solutions.svg')}})">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                ...
                <div class="d-flex mb-3 w-100 box__why justify-content-center">
                    <div class="col-sm-12 col-md-8 col-md-offset-2">
                        <div class="box__why_text__center p-3 mb-4">
                            <h4 class="text-body mb-0">Nếu bạn đang tìm kiếm một đối tác phát triển COBOL, vui
                                lòng liên hệ với chúng tôi</h4>
                        </div>
                        <div class="p-3 box__btn_contact justify-content-center text-center">
                            <a class="btn dream-btn more-btn mt-30" href="https://hachinet.com/contact">Liên hệ</a>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <link rel="stylesheet" href="{{ asset('servicecss/cobol.css') }}">
@endsection
