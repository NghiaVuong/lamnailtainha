...
@section('content')
    ...
    <section>
        ...
        <div class="container">
            <div class="col-12 row">
                ...
                <div class="col-md-4">
                    <img class="img-java-diagram" src="{{ asset('servicecss/img/java/rectangle24-java.png')}}"
                        width="100%">
                </div>
                <div class="col-md-4">
                    <div class="mg-20-jv">
    ...
    <section class="framework-url">
        ...
        <div class="row">
            <div class="col-md-8 offset-md-2">
                <img class="" src="{{ asset('servicecss/img/java/rectangle34-java.png')}}" width="100%">
            </div>
        </div>
        <br><br>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3" style="padding: 0px;">
                    <div>
                        <img class="" src="{{ asset('servicecss/img/java/rectangle36-java.png')}}" width="100%">
                    </div>
                </div>
                <div class="col-md-3" style="padding: 0px;">
                    <div>
                        <img class="" src="{{ asset('servicecss/img/java/rectangle37-java.png')}}" width="100%">
                    </div>
                </div>
                <div class="col-md-3" style="padding: 0px;">
                    <div>
                        <img class="" src="{{ asset('servicecss/img/java/rectangle38-java.png')}}" width="100%">
                    </div>
                </div>
                <div class="col-md-3" style="padding: 0px;">
                    <div>
                        <img class="" src="{{ asset('servicecss/img/java/rectangle39-java.png')}}" width="100%">
                    </div>
                </div>
            </div>
        </div>
    ...
    <link rel="stylesheet" href="{{ asset('servicecss/java.css') }}">
@endsection
