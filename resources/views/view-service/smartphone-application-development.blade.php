...
@section('content')
    <header class="bg-gradient text-center text-body" id="home">
        ...
        <div class="img-holder mt-3"><img src="{{ asset('servicecss/img/mobile/iphonex.png')}}" alt="phone"
                class="img-fluid"></div>
    </header>
    ...
    <div class="section">
        ...
        <div class="container">
            ...
            <div class="perspective-phone">
                <img src="{{ asset('servicecss/img/mobile/perspective.png')}}" alt="mobile application outsource"
                    class="img-fluid">
            </div>
        </div>
            ...
            <div class="tab-content">
                <div class="tab-pane fade show active" id="communication">
                    <div class="d-flex flex-column flex-lg-row">
                        <img src="{{ asset('servicecss/img/mobile/graphic.png')}}" alt="graphic"
    ...
    <div class="section">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <img src="{{ asset('servicecss/img/mobile/dualphone.png')}}" alt="dual phone" class="img-fluid">
                </div>
    ...
    <div class="section light-bg">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4">
                    <img src="{{ asset('servicecss/img/mobile/iphonex.png')}}" alt="iphone" class="img-fluid">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="section light-bg" id="gallery">
        <div class="container">
            ...
            <div class="img-gallery owl-carousel owl-theme">
                <img src="{{ asset('servicecss/img/mobile/screen1.jpg') }}" alt="image">
                <img src="{{ asset('servicecss/img/mobile/screen2.jpg') }}" alt="image">
                <img src="{{ asset('servicecss/img/mobile/screen3.jpg') }}" alt="image">
                <img src="{{ asset('servicecss/img/mobile/screen1.jpg') }}" alt="image">
            </div>
    ...
    <link rel="stylesheet" href="{{ asset('servicecss/themify-icons.css') }}">
    <link rel="stylesheet" href="{{ asset('servicecss/mobileapp.css') }}">
@endsection
@section('scripts')
    <script src="{{ asset('servicecss/owl.carousel.min.js') }}"></script>
    <script>
