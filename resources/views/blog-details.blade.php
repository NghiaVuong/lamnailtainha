...
@section('title', $blog->title . ' - ' . app_name())
@section('section')
    <main id="main">
                    ...
                    <div class="col-lg-8 entries">
                        <article class="entry entry-single">
                            ...
                            <div class="entry-meta">
                                <ul>
                                    ...
                                    <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <time
                                            datetime>{{ $blog->created_at->format('Y-m-d') }}</time></a></li>
                            ...
                            <div class="entry-footer">
                                ...
                                @foreach ($blog->categories as $element)
                                    @if ($element->status == 'active')
                                        <ul class="cats">
                                            <li><a
                                              href="{{ route('category.slug', $element->slug) }}">{{ $element->name }}</a>
                                            </li>
                                        </ul>
                                    @endif
                                @endforeach
