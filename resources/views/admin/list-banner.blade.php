...
@section('content')
    ...
    <div class="col-md-12 table-content">
        <div class="row mb-3">
            <div class="col-12">
                <a class="btn w-25" href="{{ route('add-banner.get') }}">
                            ...
                            <tbody>
                                @foreach ($responses as $element)
                                    <tr id="{{ $element->id }}">
                                        ...
                                        <td><a href="{{ route('edit-banner.post', $element->id) }}">
                                                {{ $element->title }}</a></td>

                                        <td>
                                            <form action="{{ route('changeStatus1.post') }}" method="post">
                                                @csrf
                                        ...
                                        <td class="w-25"> {{ ($element->tag) }}
                                        </td>

                                        <td>
                                            <a href="{{ route('edit-banner.post', $element->id) }}"><i
                            ...
                            <div class="modal-content">
                                <form id="deleteForm" action="#" method="post">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <label> Bạn chắc chắn muốn xóa slide ?</label>
                                        <p></p>
...
<script src="{{ asset('js/banner.js') }}"></script>
    ...
    <script>
        $('#warning').on('show.bs.modal', function(event) {
            ...
            $("#deleteForm").attr("action", "{{ route('delete-banner.get', '') }}" + "/" + id);
        });
